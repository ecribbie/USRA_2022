...
def add_adj(adj_dict,fam1,fam2,gene1,gene2,dir1,dir2):
	if '_'.join([fam1,fam2,dir1,dir2]) not in adj_dict:
		adj_dict['_'.join([fam1,fam2,dir1,dir2])]=[]
	adj_dict['_'.join([fam1,fam2,dir1,dir2])].append(' '.join([gene1,gene2]))
	return(adj_dict)
...
def get_adj_dict(adjacencies_file,fam_dict):
	...
	for line in adj:
		...
		if int(fam1)==int(fam2):
			adj_dict=add_adj(adj_dict,fam1,fam2,gene1,gene2,dir1,dir2)
		elif int(fam1)<int(fam2):
			adj_dict=add_adj(adj_dict,fam1,fam2,gene1,gene2,dir1,dir2)
		elif int(fam1)>int(fam2):
			adj_dict=add_adj(adj_dict,fam2,fam1,gene2,gene1,dir2,dir1)
	return(adj_dict)
